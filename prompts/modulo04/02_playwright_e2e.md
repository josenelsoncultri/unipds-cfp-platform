Atue como um Engenheiro de QA Autônomo. Não realize nenhuma ação inicialmente, monte todo o plano para depois realizar a execução.

Sua tarefa é validar o fluxo de "Cadastro de Local do Evento" no nosso monorepo NX.
Siga exatamente estes passos:
1. O ambiente completo será iniciado pelo desenvolvedor a cargo da sua execução. Assuma que o servidor está online.
